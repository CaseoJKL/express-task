...
router.get("/info/prices/:symbolName", async (req, res) => {
    ...
    const result = await axios({
      method: "post",
      url:
        `https://min-api.cryptocompare.com/data/price?fsym=${symbolName}&tsyms=USD&api_key=${process.env.CRYPTOCOMPARE_API_KEY}`,
    });
  ...
  router.get("/wallet/:walletAddress", async (req, res) => {
    ...
    return res.json({// @ts-ignore: Object is possibly 'null'.
